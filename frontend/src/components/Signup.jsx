        ...
        <form onSubmit={onSubmitHandler} action="">
          ...
          <div className='flex items-center my-4'>
            <div className='flex items-center'>
              <p className='text-gray-100'>Male</p>
              <input
                type="checkbox"
                checked={user.gender === "male"}
                onChange={() => handleCheckbox("male")}
                defaultChecked
                className="checkbox mx-2 border border-gray-900" />
            </div>
            <div className='flex items-center'>
              <p className='text-gray-100'>Female</p>
              <input
                type="checkbox"
          ...
          <p className='text-center my-2 text-gray-900'>Already have an account? <Link to="/login"> <span className='text-gray-900'>login</span>  </Link></p>
          <div>
